package com.foresight.clickonmoney.ResideMenu;
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (!ViewConfiguration.get(context).hasPermanentMenuKey()) {
                ...
                if (context.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
                    Log.d("==>", "In If");
                    layoutParams.setMargins(0, TypedValue.complexToDimensionPixelSize(tv.data, getResources().getDisplayMetrics()), 0, AppConstant.dpToPx(48, context));
                } else {
                    Log.d("==>", "In else");
                    layoutParams.setMargins(0, AppConstant.dpToPx(56, context), 0, AppConstant.dpToPx(48, context));
                }
                scrollViewLeftMenu.setLayoutParams(layoutParams);
//                scrollViewRightMenu.setLayoutParams(layoutParams);
            }
        }
    }
